...
- Follow the [Developing Bots](https://coder.github.io/balatrobot/0.7.0/developing-bots/index.md) guide for complete bot setup
- Understand the underlying [Protocol API](https://coder.github.io/balatrobot/0.7.0/protocol-api/index.md) for advanced usage
- Reference the [Installation](https://coder.github.io/balatrobot/0.7.0/installation/index.md) guide for environment setup
