...
- Explore the [BalatroBot API](https://s1m0n38.github.io/balatrobot/0.5.0/balatrobot-api/index.md) for detailed client and model documentation
- Learn about the underlying [Protocol API](https://s1m0n38.github.io/balatrobot/0.5.0/protocol-api/index.md) for TCP communication details
