...
- Use the [BalatroBot API](https://s1m0n38.github.io/balatrobot/0.4.1/balatrobot-api/index.md) `BalatroClient` for managed connections
- See [Developing Bots](https://s1m0n38.github.io/balatrobot/0.4.1/developing-bots/index.md) for complete bot implementation examples
