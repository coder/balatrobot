...
1. **Lovely Injector** (v0.8.0+) - Follow the [installation guide](https://github.com/ethangreen-dev/lovely-injector#manual-installation)
1. **Steamodded** (v1.0.0-beta-1221a+) - Follow the [installation guide](https://github.com/Steamodded/smods/wiki)
1. **Uv** (v0.9.21+) - Follow the [installation guide](https://docs.astral.sh/uv)
...
For detailed CLI options and usage, see the [CLI Reference](https://coder.github.io/balatrobot/1.2.2/cli/index.md).
...
For more troubleshooting help, see the [CLI Reference](https://coder.github.io/balatrobot/1.2.2/cli/index.md).
