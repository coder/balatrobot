...
- Use the [BalatroBot API](https://coder.github.io/balatrobot/0.7.1/balatrobot-api/index.md) `BalatroClient` for managed connections
- See [Developing Bots](https://coder.github.io/balatrobot/0.7.1/developing-bots/index.md) for complete bot implementation examples
