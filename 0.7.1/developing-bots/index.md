...
- Explore the [BalatroBot API](https://coder.github.io/balatrobot/0.7.1/balatrobot-api/index.md) for detailed client and model documentation
- Learn about the underlying [Protocol API](https://coder.github.io/balatrobot/0.7.1/protocol-api/index.md) for TCP communication details
