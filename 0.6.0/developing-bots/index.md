...
- Explore the [BalatroBot API](https://coder.github.io/balatrobot/0.6.0/balatrobot-api/index.md) for detailed client and model documentation
- Learn about the underlying [Protocol API](https://coder.github.io/balatrobot/0.6.0/protocol-api/index.md) for TCP communication details
