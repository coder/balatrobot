...
For detailed method documentation including parameters and schemas, see the [OpenRPC specification](https://coder.github.io/balatrobot/latest/src/lua/utils/openrpc.json).
...
On success, prints JSON result to stdout (exit code 0). On error, prints `Error: NAME - message` to stderr (exit code 1).
