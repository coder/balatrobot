...
For detailed method documentation including parameters and schemas, see the [OpenRPC specification](https://coder.github.io/balatrobot/1.4.1/src/lua/utils/openrpc.json).
