...
- Explore the [BalatroBot API](https://coder.github.io/balatrobot/0.7.2/balatrobot-api/index.md) for detailed client and model documentation
- Learn about the underlying [Protocol API](https://coder.github.io/balatrobot/0.7.2/protocol-api/index.md) for TCP communication details
